...
export function LoginForm({
  ...
  const [dadosLogin, setDadosLogin] = useState({
    login: "",
    senha: "",
    grupo: "aluno" as "aluno" | "administrador"
  })
  ...
  // Handler para toggle de visibilidade da senha
  ...
  const handleLoginSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log('🔐 Tentando fazer login de aluno:', dadosLogin)
      ...
      console.log('✅ Login de aluno realizado, redirecionando para dashboard')
